...
public class FragmentVistaTablets extends Fragment {
    //--------------------------------------------------------------------------------------------------
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista =inflater.inflate(R.layout.fragment_fragment_vista_tablets, container, false);
        ...
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb1));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb9));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb8));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb7));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb5));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb4));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb8));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb1));
        //--------------------------------------------------------------------------------------------------
        ...
        //LLENANDO DATOS DEL ARRAY LIST
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb5));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb8));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb7));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb8));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb1));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb9));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb9));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb1));
        //--------------------------------------------------------------------------------------------------
        ...
        //LLENANDO DATOS DEL ARRAY LIST
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb1));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb8));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb4));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb5));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb1));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb8));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb9));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.tb3));
        //--------------------------------------------------------------------------------------------------
