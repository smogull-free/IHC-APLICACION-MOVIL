...
public class FragmentVistaCelulares extends Fragment {
    //--------------------------------------------------------------------------------------------------
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_fragment_vista_celulares, container, false);
        ...
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl1));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl2));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl1));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl4));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl5));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl8));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl4));
        productos_mas_vendidos.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl10));
        //--------------------------------------------------------------------------------------------------
        ...
        //LLENANDO DATOS DEL ARRAY LIST
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl1));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl2));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl4));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl5));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl8));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl2));
        productos_oferta.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl10));
        //--------------------------------------------------------------------------------------------------
        ...
        //LLENANDO DATOS DEL ARRAY LIST
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl1));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl2));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl4));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl5));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl7));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl8));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl2));
        productos_recientes.add(new ModeloProducto("v5 AC plus","15 Units","$150.56",R.drawable.cl10));
        //--------------------------------------------------------------------------------------------------
